...
export default function SettingsPageLayout({ children, hidden }: LayoutProps) {
  return (
    <div className='text-neutral-950 dark:text-neutral-200 lg:grid lg:grid-cols-12 h-full w-screen px-4 pt-6 lg:px-0 lg:pt-0 lg:w-full dark:bg-neutral-950'>
      <div
        className={`lg:flex flex-col col-span-3 lg:border-r border-neutral-200 dark:border-neutral-800 gap-2 lg:pt-5 lg:pr-4 lg:pl-8 ${hidden ? "hidden lg:flex" : ""}`}
      >
